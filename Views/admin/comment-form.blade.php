...
{!! Form::open(['route'=>['comments.post', 'id' => @$item->id],  'files'=>true, 'method' => 'post'])  !!}

    <!--BUTTONS-->
    <div class='btn-form'>
        <!-- DELETE BUTTON -->
        @if($item)
            <a href="{!! URL::route('comments.delete',['id' => @$item->id, '_token' => csrf_token()]) !!}"
