...
CREATE TABLE `comments` (
  ...
  `comment_overview` varchar(500) CHARACTER SET utf8 DEFAULT NULL,
  `comment_description` text CHARACTER SET utf8,
  `comment_slug` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comment_image` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `comment_files` varchar(10000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `comments` (`comment_id`, `user_id`, `user_email`, `user_full_name`, `category_id`, `comment_name`, `comment_overview`, `comment_description`, `comment_slug`, `comment_image`, `comment_files`, `comment_status`, `created_at`, `updated_at`) VALUES
