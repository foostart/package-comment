<div class="type-1214">
    <header>
        <!--MENU-->
        <div class="navbar navbar-default navbar-fixed-top" id="menu-front">
            <div class="container width-1214">
                <!--LOGO-->
                <div class="logo" id="demo">
                    <a href="#">
                        <img  class = "img-logo" src="http://localhost/laravel/vendor/foostart/package-comment/public/images/logo-dark.png"
                             alt=""/>
                    </a>
                </div>
                <!--/END LOGO-->
